...
$progressBarText       = "Mapeando unidades de rede..."
...
$logfile               = "C:\OneDriveMapper\OneDriveMapper_$version.log"    #Logfile to log to 
if($hideConsole){
...
$onedriveIconPath = "C:\OnedriveMapper\onedrive.ico" #if this file exists, and you've set addShellLink to True, it will be used as icon for the shortcut
$sharepointIconPath = "C:\OnedriveMapper\sharepoint.ico" #if this file exists, and you've set addShellLink to True, it will be used as icon for the shortcut
